    ...
    <div class="container mt-4">
        ...
        <div class="row align-items-center py-4">
            ...
            <div class="col-12 col-sm-6">
                <div class="card shadow-sm mb-5 mt-5">
                    <img src="public/img/sucursal_1.jpg" class="card-img-top img-fluid" alt="Sucursal Recoleta">
                    <div class="card-body">
            ...
            <div class="col-12 col-sm-6">
                <div class="card shadow-sm mb-2">
                    <img src="public/img/sucursal_2.jpg" class="card-img-top img-fluid" alt="Sucursal Palermo">
                    <div class="card-body">
                ...
                <div class="card shadow-sm mb-2">
                    <img src="public/img/sucursal_3.jpg" class="card-img-top img-fluid" alt="Sucursal Villa Crespo">
                    <div class="card-body">
        ...
        <div class="row py-4 mb-3 justify-content-center">
            ...
            <div class="owl-carousel owl-theme">
                <div> <img src="public/img/merienda5.jpg" class="d-block w-100"
                        alt="Imagen de merienda buffet para compartir.">
                </div>
                <div> <img src="public/img/merienda1.jpg" class="d-block w-100" alt="Te con pastries.">
                </div>
                <div> <img src="public/img/merienda6.jpg" class="d-block w-100" alt="Opciones saladas."></div>
                <div> <img src="public/img/merienda8.jpg" class="d-block w-100" alt="Opciones dulces y saladas."> </div>
                <div> <img src="public/img/merienda7.jpg" class="d-block w-100"
                        alt="Bocaditos, parte de la merienda buffet.">
                </div>
                <div> <img src="public/img/merienda9.jpg" class="d-block w-100" alt="Foto de masas rellenas.">
                </div>
            </div>
                ...
                <div id="coverflow" class="col-12">
                    <ul class="flip-items">
                        <li data-flip-title="Paula Schenn">
                            <div class="card shadow-sm text-dark bg-light mb-3">
                                <div class="card-header">
                                    <img src="public/img/cliente_1.png" class="card-img-top" alt="Chica sonriente">
                                </div>
                                <div class="card-body">
                        ...
                        <li data-flip-title="Tina Bloom">
                            <div class="card shadow-sm text-dark bg-light mb-3">
                                <div class="card-header">
                                    <img src="public/img/cliente_2-01.png" class="card-img-top" alt="Chica sonriente">
                                </div>
                                <div class="card-body">
                        ...
                        <li data-flip-title="Peter Parker">
                            <div class="card shadow-sm text-dark bg-light mb-3">
                                <div class="card-header">
                                    <img src="public/img/cliente_3-01.png" class="card-img-top" alt="Chico sonriendo">
                                </div>
                                <div class="card-body">
