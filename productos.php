    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            <div class="container-fluid align-items-center">
                <a class="navbar-brand" href="index.php"><img src="public/img/logo_wonderland.png"
                        alt="logo de la web"></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mb-4">
                    <div id="tienda">
                        <h1 class="display-1 py-2 d-block ml-5 mt-4">Nuestros productos</h1>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row d-flex bg-light py-4">
                    <footer class="col-12 justify-content-center align-items-center text-center">
                        ...
                        <div class="col-12 justify-content-center">
                            <a href="https://www.instagram.com/"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            <a href="https://www.google.com/intl/es-419/gmail/about/"><svg
                            ...
                            <a href="https://ar.linkedin.com/"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            <a href="https://web.whatsapp.com/"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
