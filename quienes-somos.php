    ...
    <div class="container">
        <div class="col-12 mt-4">
            <div id="quienes_somos">
                <h1 class="display-1 py-2 d-block ml-5 text-center">Quiénes somos</h1>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <p class="lead my-4 pt-2">Bienvenidos a Wonderland, un rincón encantador en el corazón de Buenos
                        Aires donde
                        cada taza cuenta una historia y cada sabor despierta los sentidos.</p>
                </div>
                <div class="col-8">
                    ...
                    <div class="col-8">
                        <div id="carouselExampleIndicators" class="carousel slide custom-carousel mb-4 col-12"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="public/img/equipo_1.jpg" class="d-block w-100 img-fluid"
                                        alt="Chico sirviendo café">
                                </div>
                                <div class="carousel-item">
                                    <img src="public/img/equipo_2.jpg" class="d-block w-100 img-fluid"
                                        alt="Chico sirviendo café">
                                </div>
                                <div class="carousel-item">
                                    <img src="public/img/equipo_3.jpg" class="d-block w-100 img-fluid"
                                        alt="Chico sirviendo café">
                                </div>
                                <div class="carousel-item">
                                    <img src="public/img/equipo_4.jpg" class="d-block w-100 img-fluid"
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-8 mb-4">
                                <img src="public/img/equipo_5.jpg" class="d-block w-100 img-fluid mt-5"
